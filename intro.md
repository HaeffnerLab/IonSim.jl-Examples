...
* **Learn**: This section is meant to be a pedagogical introduction to the core concepts in Trapped ions (state preparation, single-ion operations, entanglement-operations).
